...
**[JARVIS](https://github.com/Aaryansinngh)** — *Local-First Personal AI Operating System*

A persistent, privacy-preserving developer assistant running entirely on local hardware. Features a knowledge graph memory layer (SQLite), semantic codebase indexing (ChromaDB + RAG), Ollama LLM integration, a FastAPI backend, and a VS Code extension. Engineered for sub-5-second cold starts via lazy-loaded ML pipelines. Think of it as your own private Copilot — with full control over your data.

`Python` `FastAPI` `ChromaDB` `Ollama` `SQLite` `RAG` `VS Code API`
...
<details open>
<summary><b>🔴 Security & Intrusion Detection</b></summary>
<br>

**[ML Intelligent Firewall](https://github.com/Aaryansinngh/ml-intelligent-firewall)**
> Real-time network intrusion detection system powered by **LightGBM** with hyperparameter tuning via GridSearchCV. Trained on the CICIDS 2018 dataset — one of the most comprehensive modern network traffic benchmarks. Evaluated with ROC-AUC curves and confusion matrices. Designed for production-grade deployment in network security pipelines.

`Python` `LightGBM` `scikit-learn` `CICIDS 2018` `Network Security` `GridSearchCV`

</details>

<details>
<summary><b>🟡 AI Safety & Verification</b></summary>
<br>
...
<img height="160" src="https://github-readme-stats.vercel.app/api?username=Aaryansinngh&show_icons=true&theme=github_dark&hide_border=true&bg_color=0d1117&title_color=58a6ff&icon_color=58a6ff&text_color=8b949e&include_all_commits=true&count_private=true" />
<img height="160" src="https://github-readme-stats.vercel.app/api/top-langs/?username=Aaryansinngh&theme=github_dark&hide_border=true&bg_color=0d1117&title_color=58a6ff&text_color=8b949e&layout=compact&langs_count=6" />

</div>

<div align="center">

[![GitHub Streak](https://streak-stats.demolab.com?user=Aaryansinngh&theme=github-dark-blue&hide_border=true&background=0d1117&stroke=58a6ff&ring=58a6ff&fire=ff6b35&currStreakLabel=58a6ff)](https://git.io/streak-stats)
